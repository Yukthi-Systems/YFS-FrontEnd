...
(issues, PRs, discussions) and the [Discord server](https://discord.gg/29zTxvque)
...
reported by DMing a maintainer/moderator on [Discord](https://discord.gg/29zTxvque),
or by opening a [confidential security advisory](https://github.com/Yukthi-Systems/YFS-FrontEnd/security/advisories/new)
on this repo if you'd rather not report it in a space visible to other members.
